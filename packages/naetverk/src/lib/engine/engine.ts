...
import { Data, NodeData, WorkerOutputs } from '../core';
import { EngineEvents, EngineEventsTypes } from './events';
...
export class Engine extends Context<EngineEventsTypes> {
  args: unknown[] = [];
  data: Data | null = null;
